...
const Square = ({ index, onClick, player }: Props) => {
  ...
  return (
    <div
      ...
      className={`h-36 border-solid border-4 border-slate-200 font-display text-5xl lg:text-7x text-center flex justify-center items-center cursor-pointer ${hoverStyle}`}
      {...{ onClick }}
    >
      <span
        data-cell-index={index}
